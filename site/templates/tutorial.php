            ...
            <div class="content">
				...
				<div id="formatButtons">
					<a href="<?php echo $page->url() . "?format=mac"  ?>">
						...
						<?php } else { ?>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 78 64"><defs><style>.cls-9{fill:#00acff;}</style></defs><g id="Layer_19" data-name="Layer 19"><path class="cls-9" d="M75.5,0H2.5A2.5,2.5,0,0,0,0,2.5v48A2.5,2.5,0,0,0,2.5,53h73A2.5,2.5,0,0,0,78,50.5V2.5A2.5,2.5,0,0,0,75.5,0M75,42a1,1,0,0,1-1,1H4a1,1,0,0,1-1-1V4A1,1,0,0,1,4,3H74a1,1,0,0,1,1,1ZM51.57,64H26.42a.5.5,0,0,1-.31-.89l3.29-2.63a2,2,0,0,0,.73-1.24L31,54H47l.87,5.24a2,2,0,0,0,.73,1.24l3.29,2.63a.5.5,0,0,1-.32.89"/></g></svg>
						<?php } ?>
					</a>
					<?php if($hasiPad) { ?>
					<a href="<?php echo $page->url() . "?format=ipad"  ?>">
						...
						<?php } else { ?>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 64"><defs><style>.cls-9{fill:#00acff;}</style></defs><g id="Layer_19" data-name="Layer 19"><path class="cls-9" d="M45,3a1,1,0,0,1,1,1V60a1,1,0,0,1-1,1H4a1,1,0,0,1-1-1V4A1,1,0,0,1,4,3H45m0-3H4A4,4,0,0,0,0,4V60a4,4,0,0,0,4,4H45a4,4,0,0,0,4-4V4a4,4,0,0,0-4-4M56,13.5V17H53V13.5a1.5,1.5,0,0,1,3,0M53,18V57.6a4.15,4.15,0,0,0,.07.79l.3,1.61h2.25l.31-1.61A4.15,4.15,0,0,0,56,57.6V18Zm1,45.61a.45.45,0,0,0,.9,0L55.44,61H53.56Z"/></g></svg>
						<?php } ?>
					</a>
					<?php } ?>
					<?php if($hasiPhone) { ?>
					<a href="<?php echo $page->url() . "?format=iphone"  ?>">
						...
						<?php } else { ?>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 64"><defs><style>.cls-9{fill:#00acff;}</style></defs><g id="Layer_19" data-name="Layer 19"><path class="cls-9" d="M29,0H5A5,5,0,0,0,0,5V59a5,5,0,0,0,5,5H29a5,5,0,0,0,5-5V5a5,5,0,0,0-5-5m3,59a3,3,0,0,1-3,3H5a3,3,0,0,1-3-3V5A3,3,0,0,1,5,2H8a2,2,0,0,1,2,2,2,2,0,0,0,2,2H22a2,2,0,0,0,2-2,2,2,0,0,1,2-2h3a3,3,0,0,1,3,3Z"/></g></svg>
						<?php } ?>
					</a>
					<?php } ?>
				</div>
