...
<?php snippet('hero') ?>
        ...
        <div class="iphone-slider" role="main">
          <div id="slider" class="flexslider clearfix">
            <ul class="slides slides-wrapper clearfix">
              <li>
                <img src="<?= $page->image('iPhoneScreen1.png')->url() ?>" alt="no-image">
              </li>
              <li>
                <img src="<?= $page->image('iPhone1-Screen2.png')->url() ?>" alt="no-image">
              </li>
              <li>
                <img src="<?= $page->image('iPhone1-Screen3.png')->url() ?>" alt="no-image">
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="iphone-wrap">
        <div class="iphone-slider" role="main">
          <div id="slider" class="flexslider clearfix">
            <ul class="slides slides-wrapper clearfix">
              <li>
                <img src="<?= $page->image('iPhone2-Screen1.png')->url() ?>" alt="no-image">
              </li>
              <li>
                <img src="<?= $page->image('iPhone2-Screen2.png')->url() ?>" alt="no-image">
              </li>
              <li>
                <img src="<?= $page->image('iPhone2-Screen3.png')->url() ?>" alt="no-image">
              </li>
            </ul>
          </div>
        </div>
  ...
  <section class="iphone-section-carousel-container iphone-section-carousel-wrapper " id="vector-illustration">
      ...
      <div class="iphone-wrap">
        <div class="iphone-slider" role="main">
          <div id="slider" class="flexslider clearfix">
            <ul class="slides slides-wrapper clearfix">
              <li>
                <img src="<?= $page->image('iPhone3-Screen1.png')->url() ?>" alt="no-image">
              </li>
              <li>
                <img src="<?= $page->image('iPhone3-Screen2.png')->url() ?>" alt="no-image">
              </li>
              <li>
                <img src="<?= $page->image('iPhone3-Screen3.png')->url() ?>" alt="no-image">
              </li>
            </ul>
          </div>
        </div>
   ...
   <section class="iphone-section-carousel-container" id="vector-illustration">
    <div class="iphone-carousel-wrap container">
      ...
      <div class="iphone-section4-conatiner">
        <img src="<?= $page->image('Website-iPhone4.png')->url() ?>" alt="no-image">
      </div>
      <div class="text-boxes-block">
        <div class="text-box-wrap">
  ...
  <section class="photoshop-section ">
    ...
    <div class="photoshop-image container">
      <img src="<?= $page->image('psd-mobile-image.png')->url() ?>" alt="no-image" class="mobile-image">
			<img src="<?= $page->image('Website-iPhone5.png')->url() ?>" alt="no-image" class="desktop-image">
    </div>
  </section>
  ...
  <section class="photoshop-section">
    ...
    <div class="photoshop-image container">
      <img src="<?= $page->image('psf-mobile-image.png')->url() ?>" alt="no-image" class="mobile-image">
			<img src="<?= $page->image('Website-iPhone6.png')->url() ?>" alt="no-image" class="desktop-image">
  ...
  <section class="photoshop-section features-section">
    ...
    <div class="features-block container">
      ...
      <div class="text-box-wrap">
        ...
        <p class="sub-content">Apply Linear, Radial or Angle gradients. Easily save and reuse colors or gradients.</p>
      </div>
      <div class="text-box-wrap">
